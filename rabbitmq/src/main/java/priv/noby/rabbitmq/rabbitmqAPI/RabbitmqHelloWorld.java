...
public class RabbitmqHelloWorld {
    ...
    public static final String QUEUE_HELLO_WORLD = "queueHelloWorld";
    ...
    private static void produce(int times,long delay) throws IOException, TimeoutException {
        ...
        channel.queueDeclare(QUEUE_HELLO_WORLD, true, false, false, null);
        for (int i = 1; i <= times; i++) {
            ...
            //byte[] body             消息内容
            channel.basicPublish("", QUEUE_HELLO_WORLD, null, info.getBytes());
    ...
    private static void consumer(long delay) throws IOException, TimeoutException {
        ...
        channel.basicConsume(QUEUE_HELLO_WORLD, true, new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                System.out.println(LocalTime.now()+" 消费者消费:"+new String(body));
            }
        });
