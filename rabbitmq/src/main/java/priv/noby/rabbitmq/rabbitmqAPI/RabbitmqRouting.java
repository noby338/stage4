...
//        }
     ...
     */
    static void produce(String info, String routing) throws IOException, TimeoutException {
        //创建连接工厂
    ...
    static void consumer() throws IOException, TimeoutException {
        ...
        channel.basicConsume("queueWrong", true, new DefaultConsumer(channel) {
            public void handleDelivery(String consumerTag, Envelope envelope,
                                       ...
                                       byte[] body) {
                System.out.println("消费者queueWrong监听:" + new String(body));
            }
        });
    }
...
//        channel.queueBind("queueError", "exchangeDirect", "");
        ...
        channel.basicConsume("queueError", true, new DefaultConsumer(channel) {
            public void handleDelivery(String consumerTag, Envelope envelope,
                                       AMQP.BasicProperties properties,
                                       byte[] body) {
                System.out.println("消费者queueError监听:" + new String(body));
            }
        });
    }
}
